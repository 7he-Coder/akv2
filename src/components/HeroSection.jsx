		...
		<>
			<section className="relative inset-0 heroText place-items-center py-2 z-50 overflow-hidden">
				...
				<div className="content max-w-7xl mx-auto place-items-center pt-20 px-6">
					<h1 className="leading-none md:leading-[.9] xl:mt-4 2xl:mt-0 text-5xl sm:text-6xl md:text-8xl xl:text-HeadingText font-extrabold uppercase text-center xl:text-left max-w-min lg:max-w-full text-white bg-clip-text bg-Gradient-1">
						web developer {""}
